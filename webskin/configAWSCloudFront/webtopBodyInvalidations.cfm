...
<cftry>
	...
	<skin:view  typename="configAWSCloudFront" webskin="displayForm#URL.farcryName#">

	<cfoutput>
		<h3 style="color:##0e65a2"><span title="URL.maxrows=#URL.maxrows#">Last #URL.maxrows# records</span> Invalidations for #URL.farcryName#</h3>
